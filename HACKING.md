...
hidden if the `noditto_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `noditto_DEVELOPER_MODE` to the configure
...
Runs the executable target `noditto_elf`.
